    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = inflater
                    .inflate(R.layout.layout_item_repo,parent,false);
        ...
        viewHolder.tvRepoStars.setText(
                String.format("stars : %d", localRepo.getStars_count()));
        ImageLoader.getInstance()
                .displayImage(localRepo.getAvatar(),viewHolder.ivIcon);
        return convertView;
    }
